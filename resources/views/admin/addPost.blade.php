          ...
          <form method="POST" action="{{ route('post.store') }}" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <select name="subcategory_id" class="form-control @error('subcategory_id') is-invalid @enderror" id="">
                    ...
                    @endphp
                        ...
                        <option class="text-info" value="{{ $cat->id }}">---{{$cat->subcategory_name}}</option>
                        @endforeach
                    @endforeach
                </select>
            </div>
            ...
            @enderror
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" id="exampleInputPassword1" placeholder="Title" required>
                </div>
                @error('title')
                 <div class="alert alert-danger">{{ $message }}<div>
                @enderror
              ...
              <div class="form-floating">
                ...
                <textarea name="description" id="summernote" class="form-control @error('post_date') is-invalid @enderror" placeholder="Description" id="floatingTextarea2" style="height: 100px" required></textarea>
             ...
             @enderror
              ...
              <div class="form-group">
                ...
                <input type="date" name="post_date" class="form-control @error('post_date') is-invalid @enderror" id="exampleInputPassword1" placeholder="Date" required>
              </div>
              @error('post_date')
                 <div class="alert alert-danger">{{ $message }}<div>
                @enderror
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  <div class="custom-file">
                    <input type="file" name="image" class="custom-file-input @error('post_date') is-invalid @enderror" id="exampleInputFile">
